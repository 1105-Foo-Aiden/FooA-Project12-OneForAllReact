...
import { LevelNine } from '../Services/dataServices'
...
export default function PageNineComponent() {
    ...
    async function getResult(){
        const answer = await LevelNine(num1)
        setResult(answer)
    }
    ...
    <h1 class="text-6xl font-bold flex justify-center text-white">Revsere it Number</h1>
    <br/><br/><br/><br/><br/><br/><br/><br/>
    <div class="flex justify-center">
        <input class="flex justify-center w-fit" type="long number" placeholder="Enter a number to reverse" id="UserInput1" onChange={(e) => setNumOne(e.target.value)}/>  
        <br/><br/>
    </div>
    <br/><br/><br/><br/><br/>
    <div class="flex justify-center">
