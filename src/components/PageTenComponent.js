...
import { LevelTen } from '../Services/dataServices'
...
export default function PageTenComponent() {
    ...
    async function getResult(){
        const answer = await LevelTen(num1)
        setResult(answer)
    }
    ...
    <h1 class="text-6xl font-bold flex justify-center text-white">Restaurant Picker</h1>
    <br/><br/><br/><br/><br/><br/><br/><br/>
    <div class="flex justify-center">
        <input class="flex justify-center w-fit" type="text" placeholder="Enter a type of restaurant" id="UserInput1" onChange={(e)=>setNumOne(e.target.value)}/>  
        <br/><br/>
    </div>
    <br/><br/><br/><br/><br/>
    <div class="flex justify-center">
