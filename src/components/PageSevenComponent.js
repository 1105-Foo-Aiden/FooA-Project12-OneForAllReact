...
import { LevelSeven } from '../Services/dataServices';
...
export default function PageSevenComponent() {
  ...
  const [result, setResult] = useState('')
    ...
    async function getResult(){
        const answer = await LevelSeven(word)
        setResult(answer)
    }
    ...
    <h1 class="text-6xl font-bold flex justify-center text-white">Reverse It Word</h1>
    <br/><br/><br/><br/><br/><br/><br/><br/>
    <div class="flex justify-center">
        <input class="flex justify-center w-70" type="text" placeholder="Enter a word to reverse" id="UserInput1" onChange={(e)=>setWord(e.target.value)}/>  
        <br/><br/>
    </div>
    <br/><br/><br/><br/><br/>
    <div class="flex justify-center">
